...
const PuneToMumbai = () => {
  ...
  const schema = {
    ...
    "description": "Book Pune to Mumbai one way and round trip cab starting ₹2,999.",
  ...
  return (
    <>
      <SEO
        title="Pune to Mumbai Cab | One Way & Round Trip from ₹2,999"
        description="Pune to Mumbai cab starting ₹2,999. Sedan, SUV, Innova Crysta. Airport transfers, doorstep pickup, transparent pricing."
        schema={schema}
      />
      ...
      <style>{`
        ...
        .page-hero p {
          font-size: 1rem; color: var(--text-muted); max-width: 640px;
          line-height: 1.65;
        }
        .page-hero-meta {
        ...
        .price-table th {
          background: var(--cream); padding: 0.85rem 1.25rem;
        ...
        .info-card li::before {
          ...
          width: 5px; height: 5px; border-radius: 50%; background: var(--text-main);
        }
      ...
      <section className="page-hero">
        <div className="container">
          <div className="eyebrow">Pune → Mumbai Route</div>
          <h1>Pune to Mumbai <em>Cab Service</em></h1>
          <p>
            Reliable, comfortable, and affordable one-way & round-trip taxi service from Pune to Mumbai via the Pune-Mumbai Expressway. Doorstep pickup, professional chauffeurs, and transparent flat rates.
          </p>
        ...
        <div className="container">
          <div style={{ marginBottom: '2rem' }}>
            ...
            <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.25rem)', fontWeight: 700 }}>
              Pune to Mumbai <em style={{ fontStyle: 'italic', fontWeight: 400 }}>Cab Rates</em>
            </h2>
          </div>

          <div className="price-table-wrap">
            <table className="price-table" id="pune-mumbai-price-table">
              <thead>
                <tr>
                  <th>Vehicle</th>
                  <th>Seating</th>
              ...
              <tbody>
                {activeVehicles.map(v => (
                  <tr key={v.id}>
                    ...
                    <td>{v.seating}</td>
                    <td className="price">₹{v.puneToMumbaiOneWay.toLocaleString('en-IN')}</td>
                    <td className="price">₹{v.puneToMumbaiRoundTrip.toLocaleString('en-IN')}</td>
                    <td>
                      <Link to={`/contact-booking?vehicle=${v.id}&route=pune-to-mumbai`} className="btn btn-primary btn-sm">
                        Book
                      </Link>
                    </td>
                  </tr>
          ...
          <div className="info-grid">
            <div className="info-card">
              <h3>Popular Pickup Points in Pune</h3>
              <ul>
                ...
                <li>Kothrud, Karve Nagar & Warje</li>
              </ul>
            </div>
            <div className="info-card">
              <h3>Popular Drop Points in Mumbai</h3>
              <ul>
                <li>Mumbai Airport T1 (Domestic) & T2 (International)</li>
                <li>Dadar, Prabhadevi & Worli</li>
                <li>Andheri East/West & Goregaon</li>
                <li>BKC (Bandra Kurla Complex)</li>
                <li>Powai, Vikhroli & Ghatkopar</li>
                <li>Navi Mumbai — Vashi, Belapur, Airoli</li>
                <li>Thane, Dombivli & Kalyan</li>
              </ul>
            </div>
          </div>
          ...
          <div className="page-cta">
            <h3>Book your Pune to Mumbai <em>cab now</em></h3>
            <p>Instant booking with confirmed driver details. No advance payment required.</p>
            <div className="cta-btns">
              <Link to="/contact-booking?route=pune-to-mumbai" className="btn btn-primary" id="ptm-book-btn">
                Book Pune to Mumbai Cab
              </Link>
              <a href="tel:+919000000000" className="btn btn-outline">
                Call to Book
              </a>
            </div>
          </div>
